...
I used Apriori algorithms for the MBA, to identify association rules  among items and to find item sets that are frequently bought together.
Support, Confidence and Lift values of the association rules to understand the strength and significance of the relationship.
